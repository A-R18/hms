...
const { addPatient, showSinglePatient, showPatients, fetchExistingPatient, updatePt, deletePt } = require("../models/patient.model.js");
...
const registerPatient = async (req, res) => {
    try {
        ...
        if (!validatedResult.isEmpty()) {
            return res.status(400).json({ message: "validations errors", errors: validatedResult.array() });
        }
